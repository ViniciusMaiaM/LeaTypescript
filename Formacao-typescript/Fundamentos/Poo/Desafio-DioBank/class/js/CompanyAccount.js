...
var CompanyAccount = /** @class */ (function (_super) {
    ...
    function CompanyAccount(name, account_number) {
        var _this = _super.call(this, name, account_number) || this;
        _this.get_loan = function (dp) {
            if (_this.validate_status()) {
                _this.deposit(dp);
                console.log("You've added ".concat(dp, " to your balance, now it's ").concat(_this.get_balance()));
            }
            else {
